...
app = FastAPI(
    ...
    description="Rails REST API: REST API with Ruby on Rails, Devise, PostgreSQL, and Sidekiq",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "rails-rest-api"}
